...
for t in ERR1395613 ERR1395610 SRR5571991 SRR5571990 SRR5571985;
  do
    # Suppress a lot of output to be fair
    ./cgmemtime/cgmemtime ./kraken2/k2 classify --threads 10 --db ./k2/viral_db --output - --report ${res_path}/reports/viral_k2_${t}.tsv ${file_path}/${t}_1.fastq.gz  > ${res_path}/logs/match_k2_viral_${t}.log
  done
...
for t in ERR1395613 ERR1395610 SRR5571991 SRR5571990 SRR5571985;
  do
    # Suppress a lot of output to be fair
    ./cgmemtime/cgmemtime ganon classify --db-prefix ./ganon/viral_db -o ./ganon/${db}_perf_${id} --threads 10 -s ./data/fastq/${id}_1.fastq.gz > ${res_path}/logs/match_ganon_viral_${t}.log
  done
