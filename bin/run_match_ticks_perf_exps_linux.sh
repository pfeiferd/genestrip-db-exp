...
for t in tick1 tick2 tick3 tick4 tick5 tick6 tick7 tick8;
  do
    # Suppress a lot of output to be fair
    ./cgmemtime/cgmemtime ganon classify --db-prefix ./ganon/tick-borne_db -o ./ganon/tick_perf_ganon_${t} --threads 10 -s ./data/fastq/${t}.fastq.gz > ${res_path}/logs/match_ganon_viral_${t}.log
  done

./cgmemtime/cgmemtime ganon classify --db-prefix ./ganon/tick-borne_db -o ./ganon/tick_perf_ganon_allticks --threads 10 -s ${file_path}/tick2.fastq.gz ${file_path}/tick3.fastq.gz ${file_path}/tick4.fastq.gz ${file_path}/tick5.fastq.gz ${file_path}/tick6.fastq.gz ${file_path}/tick7.fastq.gz ${file_path}/tick8.fastq.gz > ${res_path}/logs/match_ganon_viral_allticks.log
