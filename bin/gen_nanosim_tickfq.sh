...
do
  ...
  ${nanosimdir}/read_analysis.py metagenome -c -q --fastq -gl data/projects/tick-borne/csv/tick-borne_nanosim.tsv -i data/fastq/${file}.fastq.gz  -t 24
  ...
  ${nanosimdir}/simulator.py metagenome --chimeric --fastq -gl data/projects/tick-borne/csv/tick-borne_nanosim.tsv -t 24 -a training_quantification.tsv
